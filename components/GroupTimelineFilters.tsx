    ...
    <div className="pmmg-card p-4 space-y-3">
      ...
      <div className="flex justify-between items-center pt-1">
        <button
          ...
          className="text-[10px] font-bold uppercase tracking-wider text-pmmg-navy/70 dark:text-slate-400 flex items-center gap-1 active:opacity-70 transition-opacity"
        >
          <span className={`material-symbols-outlined text-lg ${isFilterActive ? 'text-pmmg-red fill-icon' : 'text-pmmg-navy/50 dark:text-slate-500'}`}>
            tune
          </span>
      ...
      {showAdvancedFilters && (
        <div className="space-y-4 pt-3 border-t border-pmmg-navy/10 dark:border-slate-700 animate-in fade-in slide-in-from-top-2 duration-200">
          
          {/* Filtro de Status */}
          <div>
            <label className="block text-[10px] font-bold uppercase text-pmmg-navy/70 dark:text-slate-400 mb-1 ml-1 tracking-wider">Status do Indivíduo</label>
          ...
          {/* Filtro de Autor */}
          <div>
            <label className="block text-[10px] font-bold uppercase text-pmmg-navy/70 dark:text-slate-400 mb-1 ml-1 tracking-wider">Autor do Post</label>
            <select
