...
const INITIAL_SUSPECTS: Suspect[] = [
  {
    ...
    rg: '1.234.567',
    status: 'Foragido',
    approachAddress: 'Praça da Liberdade, BH',
    residenceAddress: 'Rua dos Inconfidentes, 100, Savassi',
    timeAgo: '23 min',
  ...
  },
  {
    ...
    rg: '2.345.678',
    status: 'Suspeito',
    approachAddress: 'Mercado Central, BH',
    residenceAddress: 'Rua Curitiba, 800, Centro',
    timeAgo: '1 hora',
  ...
  },
  {
    ...
    rg: '3.456.789',
    status: 'Suspeito',
    approachAddress: 'Rua da Bahia, BH',
    timeAgo: '3 dias',
  ...
  },
  {
    ...
    rg: '4.567.890',
    status: 'Preso',
    approachAddress: 'Penitenciária Nelson Hungria',
    timeAgo: '1 ano',
  ...
  },
  {
    ...
    rg: '5.678.901',
    status: 'Foragido',
    approachAddress: 'Avenida Afonso Pena, 1500',
    timeAgo: '5 horas',
  ...
  },
  {
    ...
    approachAddress: 'Registro Antigo',
    timeAgo: '2 anos',
