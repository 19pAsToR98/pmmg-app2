      ...
      <header className="sticky top-0 z-50 bg-theme-navy px-4 py-4 flex items-center justify-between shadow-xl">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] font-medium text-theme-yellow tracking-wider uppercase mt-1">Leitura de Placa IA</p>
          </div>
        </div>
        <span className="material-symbols-outlined text-theme-yellow fill-icon">photo_camera</span>
      </header>
      ...
      <main className="flex-1 overflow-y-auto pb-4 no-scrollbar px-4 pt-6">
        ...
        <div className="flex flex-col items-center pt-4 px-6">
          ...
          <div className="relative bg-white rounded-[1.5rem] p-4 px-6 shadow-lg mb-8 text-center border-2 border-theme-navy/5 after:content-[''] after:absolute after:top-0 after:left-1/2 after:w-0 after:h-0 after:border-[20px] after:border-transparent after:border-b-white after:mt-[-20px] after:ml-[-20px] after:border-t-0">
            <p className="text-theme-navy font-semibold text-sm">
              <span className="font-bold text-theme-red">{rankLabel}</span>, insira a placa manualmente ou utilize a câmera para leitura automática.
            </p>
          </div>
        </div>
        ...
        <section className="mt-4 space-y-4">
          <div className="pmmg-card p-4 space-y-3">
            <h3 className="text-[11px] font-bold text-theme-navy/60 uppercase tracking-wider">Consulta de Veículo</h3>
            <div className="flex gap-2">
              <input 
                ...
                className="flex-1 min-w-0 px-4 py-3 bg-white border border-theme-navy/20 focus:border-theme-navy focus:ring-1 focus:ring-theme-navy rounded-lg text-sm font-bold uppercase tracking-widest" 
              ...
              <button 
                ...
                className="bg-theme-red text-white p-3 rounded-lg active:scale-95 transition-transform shrink-0"
