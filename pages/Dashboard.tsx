...
// import BottomNav from '../components/BottomNav'; // REMOVIDO: Navegação centralizada no App.tsx
    ...
    <header className="hidden lg:flex sticky top-0 z-50 bg-white/90 dark:bg-slate-800/90 backdrop-blur-md px-8 py-4 shadow-md border-b border-pmmg-navy/10 dark:border-slate-700 justify-between items-center shrink-0">
      ...
      <div className="flex items-center gap-4">
        ...
        <button 
          ...
          className="relative group text-left active:scale-[0.99] transition-transform w-80"
        >
          <div className="absolute inset-y-0 left-3 flex items-center pointer-events-none">
            <span className="material-symbols-outlined text-primary-dark text-xl">search</span>
          </div>
          <div 
            className="block w-full pl-10 pr-4 py-2 bg-pmmg-khaki/50 dark:bg-slate-700 rounded-xl border border-pmmg-navy/10 dark:border-slate-600 text-xs font-bold placeholder-pmmg-navy/40 shadow-inner text-pmmg-navy/60 dark:text-slate-300 dark:placeholder-slate-500 whitespace-nowrap overflow-hidden" 
          >
