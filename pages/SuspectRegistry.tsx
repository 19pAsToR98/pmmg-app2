      ...
      <main className="flex-1 overflow-y-auto lg:pb-4 no-scrollbar px-4 pt-6">
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-6 lg:max-w-7xl lg:mx-auto">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-[10px] font-bold uppercase text-pmmg-navy/70 dark:text-slate-400 mb-3 mt-4 text-center tracking-wider">Status de Monitoramento</p>
          ...
          {/* Coluna 2: Dados, Artigos, Veículos, Ligações */}
          <div className="lg:col-span-1">
            {/* 1. --- DADOS PESSOAIS --- */}
        ...
        <div className="mt-10 mb-8 lg:max-w-7xl lg:mx-auto">
          <button 
            onClick={handleSave}
