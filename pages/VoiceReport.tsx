...
const VoiceReport: React.FC<VoiceReportProps> = ({ navigateTo, userRank }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-pmmg-khaki dark:bg-slate-900 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto lg:pb-4 no-scrollbar px-4 pt-6 flex flex-col items-center">
        <div className="lg:grid lg:grid-cols-2 lg:gap-6 lg:max-w-5xl lg:mx-auto lg:w-full">
          ...
          {/* Coluna 2: Recording Section */}
          <section className="lg:col-span-1 flex flex-col items-center justify-center flex-1 w-full max-w-xs lg:max-w-full lg:pt-12">
