export type Screen = 'onboarding' | 'dashboard' | 'registry' | 'profile' | 'chatList' | 'chatRoom' | 'aiTools' | 'register' | 'onboardingSetup' | 'profileSettings' | 'map' | 'contacts' | 'groupManagement';
