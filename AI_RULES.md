...
*   **Mapeamento:** Google Maps (via `@react-google-maps/api`), o novo padrão para visualização de mapas táticos e geolocalização.
...
2.  **Mapas:** **Google Maps** é a biblioteca de mapeamento padrão. Todas as funcionalidades de mapa devem ser implementadas usando a API do Google Maps.
