...
*   **Mapeamento:** Leaflet, a biblioteca padrão para visualização de mapas táticos e geolocalização, alternativamente ela poderá ser alterada a pedido do usuário.
...
2.  **Mapas:** **Leaflet** é a biblioteca de mapeamento padrão . Todas as funcionalidades de mapa devem ser implementadas usando a API do Leaflet.
